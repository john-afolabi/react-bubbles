...
A token is sent in a request header and it is used for Authorization

- [x] What steps can you take in your web apps to keep your data secure?

By implementing Authorization and private routing

- [x] Describe how web servers work.

Web servers are basicaly computers that stores static files. A web browser requests for files from a web server using the http protocol and the web server responds with the requested files.
